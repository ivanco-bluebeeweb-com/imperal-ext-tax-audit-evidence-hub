...
| Pending after Marketplace approval | Imperal panel | Full fictional DemoCo P0 journey | Not started | Marketplace review keeps the app unavailable for installation; API proof does not prove panel UX. | Install, then run the mandatory panel test |
