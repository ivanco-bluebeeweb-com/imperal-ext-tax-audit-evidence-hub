...
| Pending after successful deployment | Imperal panel | Full fictional DemoCo P0 journey | Not started | App cannot be installed until deployment succeeds | Complete deploy/install, then run the mandatory live test |
